...
class ClickableTiles extends Composer
{
    protected $module;
    /**
    ...
    public function with()
    {
        ...
        return [
            ...
            'list_items' => $module['list_interlocking'] ?? [],
            'interlocking_tiles' => $module['interlocking_tiles'] ?? false,
            'orientation' => $module['orientation'] ?? false,
            'clickable_block' => $module['clickable_block'] ?? false,
        ];
    }
    ...
    protected function getClasses($module)
    {
        ...
        $styleChoice = $module['style_choice'] ?? '';
