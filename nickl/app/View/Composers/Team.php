...
class Team extends Composer
{
    ...
    public function with()
    {
        ...
        return [
            ...
            'team_members' => $this->get_team_members($module),
            'pictures_format' => $this->get_pictures_format($module),
            'align' => $this->get_alignement($module),
        ];
    }
    ...
    protected function get_team_members($module)
    {
        $teamMembers = $module['list'];
        if (!$teamMembers) {
            return [];
        }
    ...
    protected function get_pictures_format($module)
    {
        return $module['pictures_format'];
    }
    protected function get_alignement($module)
    {
        return $module['align'];
    }
