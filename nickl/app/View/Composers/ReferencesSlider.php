...
class ReferencesSlider extends Composer
{
    /**
    ...
    protected function get_refs($module)
    {
        $forcedRefsId = $module['is_manual'] ? $module['refs_id'] : null;
        $refs = ReferencesHelper::getRefs(3, $forcedRefsId);
        return $refs;
    }
