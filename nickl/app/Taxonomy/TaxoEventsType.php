...
class TaxoEventsType extends TaxoRegister
{
    protected string $slug = 'event_type';
    protected string $plural = 'Catégories d\'événements';
    protected string $singular = 'Catégories d\'événements';
