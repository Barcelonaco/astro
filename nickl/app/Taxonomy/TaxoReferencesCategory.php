...
class TaxoReferencesCategory extends TaxoRegister
{
    protected string $slug = 'ref_categorie';
    protected string $plural = 'Catégories de références';
    protected string $singular = 'Catégorie de références';
