...
<?php
$WCOrder = wc_get_order($this->order_id);
?>
...
//        foreach ($item as $k => $r) {
//            echo '<tr><td>' . $k . ' => ' . $r . '</td></tr>';
//        }
        ?>
        <tr class="<?php echo apply_filters('wpo_wcpdf_item_row_class', 'item-' . $item_id, esc_attr($this->get_type()), $this->order, $item_id); ?>">
            <td class="product">
                <?php $description_label = bcn_pll('Description', 'woocommerce-pdf-invoices-packing-slips'); // registering alternate label translation ?>
                <span class="item-name"><?php echo $item['name']; ?></span>
                <?php do_action('wpo_wcpdf_before_item_meta', $this->get_type(), $item, $this->order); ?>
                <span class="item-meta"><?php echo $item['meta']; ?></span>
                <dl class="meta">
                    <?php $description_label = bcn_pll('SKU', 'woocommerce-pdf-invoices-packing-slips'); // registering alternate label translation ?>
            ...
            <td class="tax"><?php echo $item['line_subtotal_tax']; ?></td>
    ...
    <tr class="no-borders">
        ...
        <td class="no-borders" colspan="2">
            <table class="totals">
                <tfoot>
                <tr class="card_subtotal">
                    <th class="description"><?php echo 'Sous-total'; ?></th>
                    <td class="price"><span class="totals-price"><?php $this->order_grand_total('excl') ?></span></td>
                </tr>
                <tr class="card_subtotal">
                    <th class="description"><?php echo 'TVA'; ?></th>
                    <td class="price"><span class="totals-price"><?php echo $this->format_price($WCOrder->get_total_tax()) ?></span></td>
                </tr>
                <tr class="order_total">
                    <th class="description"><?php echo 'Total'; ?></th>
                    <td class="price"><span class="totals-price"><?php echo $this->order_grand_total(); ?></span></td>
                </tr>
                </tfoot>
            </table>
        </td>
